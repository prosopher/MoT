...
echo "[Correction] shrink_ratio_chart_pdf=${SUMMARY_ROOT}/layer_idx_vs_final_shrink_ratio.pdf"
echo "[Correction] decomposition_chart_pdf=${SUMMARY_ROOT}/layer_idx_vs_correction_decomposition.pdf"
echo "[Correction] structural_advantage_chart_pdf=${SUMMARY_ROOT}/layer_idx_vs_structural_advantage.pdf"
echo "[Correction] phase_scatter_chart_pdf=${SUMMARY_ROOT}/correction_phase_scatter.pdf"
echo "[Correction] shift_norms_chart_pdf=${SUMMARY_ROOT}/layer_idx_vs_shift_norms.pdf"
